      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-sm opacity-70 max-w-md">
              Impulsa decisiones inteligentes con análisis de datos ágil,
              potente y accesible para todos.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-black/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm opacity-70">
            © {currentYear} Naurat. Todos los derechos reservados.
          </p>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            >
              <svg
                ...
                fill="currentColor"
                viewBox="0 0 24 24"
                xmlns="https://www.linkedin.com/company/naurat/"
              >
